...
| **Locket**  | Gold (vĩnh viễn đến năm 9999)                          | `Locket.js`           |
...
5. Bật VPN → Mở YouTube, Locket kiểm tra ✅
...
└── js/
    ...
    └── Locket.js           # Locket Gold + Chống cache RevenueCat
```
...
| **Locket**  | Gold（永久有效至9999年）                        | `Locket.js`           |
...
| **Locket**  | Gold（9999年まで永久有効）                                         | `Locket.js`           |
...
5. VPN をオン → YouTube、Locket を開いて確認 ✅
